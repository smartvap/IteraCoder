...
public final class RdWorkflowKeys {
    ...
    public static final String CODE_REPAIR_ANALYSIS = "code_repair_analysis";
    ...
    /** 沙箱验证错误详情（结构化存储，前端横幅直接读取） */
    public static final String HARNESS_ERROR_DETAIL = "harness_error_detail";
    /** 修复反馈：条件边检测到修复 Agent 未写文件时注入，下一轮修复 Agent 必须感知并纠正 */
